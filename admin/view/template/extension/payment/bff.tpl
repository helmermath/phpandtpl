...
<?php if ($field['name'] == 'key') { $field['type'] = 'password'; } ?>
...
<?php } // end foreach fields ?>
            <?php if($k == 0) { ?>
              <div class="form-group">
               <label class="col-sm-2 control-label" for="force_save_card">Force Saving Card:</label>
                <div class="col-sm-10">
                    <select name="force_save_card" id="force_save_card" class="form-control">
                        <option value="0"<?php if($force_save_card == 0) { echo 'selected="selected"'; }?>>Ask</option>
                        <option value="1"<?php if($force_save_card == 1) { echo 'selected="selected"'; }?>>Force</option>
                        <option value="2"<?php if($force_save_card == 2) { echo 'selected="selected"'; }?>>None</option>
                    </select>
                </div>
              </div>
              <div class="form-group">
               <label class="col-sm-2 control-label" for="show_cvv">CVV:</label>
                <div class="col-sm-10">
                  <label class="radio-inline"><input type="radio" id="show_cvv" name="show_cvv" value="1" <?php if($show_cvv == 1) { echo 'checked="checked""'; }?> > Turn On CVV</label>
                  <label class="radio-inline"><input type="radio" name="show_cvv" value="0" <?php if($show_cvv == 0) { echo 'checked="checked""'; }?>> Turn Off CVV</label>
                </div>
              </div>
            <?php }  ?>
	 	    </div>
